    ...
    <div class="max-w-lg mx-auto">
        ...
        <div class="text-center mb-10">
            <h1 class="font-display text-5xl font-light tracking-widest text-ink uppercase">
                Modifier <em class="not-italic text-rose">Contact</em>
            </h1>
                ...
                <div class="flex items-center justify-between pt-2">
                    ...
                    <button type="submit"
                            class="inline-flex items-center gap-2
                                   bg-gradient-to-r from-gold to-[#b8904d] text-white
                                   font-body text-xs font-medium tracking-[.18em] uppercase
                                   px-7 py-3 rounded-full shadow-lg shadow-gold/30
                                   transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-gold/40">
                        Mettre à jour
                    </button>
                </div>
